...
ActiveRecord::Schema.define(version: 2021_08_13_185038) do
  ...
  create_table "line_items", force: :cascade do |t|
    ...
    t.index ["travel_id"], name: "index_line_items_on_travel_id"
  end
  ...
  create_table "routes", force: :cascade do |t|
    t.string "departure"
    t.string "arrival"
    t.bigint "harbor_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["harbor_id"], name: "index_routes_on_harbor_id"
  end
  ...
  create_table "tickets", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["line_item_id"], name: "index_tickets_on_line_item_id"
    t.index ["ship_id"], name: "index_tickets_on_ship_id"
  end
